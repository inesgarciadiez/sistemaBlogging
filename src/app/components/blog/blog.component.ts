...
export class BlogComponent {
  ...
  constructor() {
    ...
    let firstNew: News = {
      ...
      text:"Horses and humans have a very ancient relationship. It is believed that Asian nomads probably domesticated the first horses some 4,000 years ago, from which time these animals remained essential to many societies until the advent of the motor. In fact, horses still hold a place of honor in many cultures, and are often linked to a multitude of war exploits.",
      date: "2022-06-22"
    }
    ...
    let secondNew: News = {
      ...
      text:"The domestic cat12 (Felis silvestris catus), more commonly called gato, and colloquially minino,3 michino,4 michi,5 micho,6 mizo,7 miz,8 morroño9 or morrongo,10 and some other names, is a carnivorous mammal of the Felidae family. It is a domesticated subspecies of the wildcat, due to its coexistence with humans. The current name in many languages comes from the Vulgar Latin catus. Paradoxically, catus alluded to wild cats, while domestic cats were called felis.",
      date: "2022-06-22"
    }

    this.arrNews.push(firstNew);
    this.arrNews.push(secondNew);
